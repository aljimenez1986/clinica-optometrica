      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-6">
        <div className="flex flex-col md:flex-row gap-4 items-center">
          ...
          <button
            ...
            className="bg-[#356375] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#2d5566] transition-all shadow-md hover:shadow-lg whitespace-nowrap flex items-center gap-2"
          >
          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-gray-50 border-b-2 border-gray-200">
              <tr>
                ...
                <th className="px-6 py-4 text-xs font-bold text-gray-700 uppercase tracking-wider">Marca</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-700 uppercase tracking-wider">Modelo</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-700 uppercase tracking-wider text-right">Acciones</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {ipadsFiltrados.length === 0 ? (
                <tr>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-3">
                        <button
                          ...
                          className="text-[#356375] hover:text-[#284b5a] font-medium flex items-center gap-1 hover:underline transition"
                        >
